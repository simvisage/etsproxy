# -*- coding: utf-8 -*-
#
# ETSproxy documentation build configuration file, created by
...
project = u'ETSProxy'
copyright = u'2012, Matthias Schmerl'
...
latex_documents = [
  ('index', 'ETSproxy.tex', u'ETSproxy Documentation',
   u'Matthias Schmerl', 'manual'),
]
...
man_pages = [
    ('index', 'etsproxy', u'ETSproxy Documentation',
     [u'Matthias Schmerl'], 1)
]
