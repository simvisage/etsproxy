...
HOME_DIR = expanduser("~")
# build directory
BUILD_DIR = os.path.join(HOME_DIR, '.etsproxy', 'docs')
...
.. image:: %s_sampling_%s.png
    :width: 24%%
        ...
        rst_text += '\nFollowing etsproxy configuration has been used to produce the sampling figures:\n\n'
        rst_text += '\n>>> print component_obj\n' + str(dobj.s) + '\n'
...
class GenDoc(HasTraits):
    ...
    html_server = 'root@mordred.imb.rwth-aachen.de:/var/www/docs/etsproxy'
